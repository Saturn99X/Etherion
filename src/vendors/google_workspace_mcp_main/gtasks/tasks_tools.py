...
async def list_task_lists(
    ...
    try:
        ...
        message = (f"API error: {error}. You might need to re-authenticate. "
                   f"LLM: Try 'start_google_auth' with the user's email ({user_google_email}) "
                   f"and service_name='Google Tasks'.")
