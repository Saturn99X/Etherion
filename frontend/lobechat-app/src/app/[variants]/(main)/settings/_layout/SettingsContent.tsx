...
const componentMap = {
  ...
  [SettingsTabs.EtherionRegistry]: dynamic(() => import('@etherion/ui/registry/agent-registry'), {
    loading: () => <Loading />,
  }),
  [SettingsTabs.EtherionHub]: dynamic(() => import('@etherion/ui/registry/integration-hub'), {
    loading: () => <Loading />,
  }),
  [SettingsTabs.EtherionTools]: dynamic(() => import('@etherion/ui/registry/mcp-tool-manager'), {
    loading: () => <Loading />,
  }),
  [SettingsTabs.EtherionKnowledge]: dynamic(() => import('@etherion/ui/registry/knowledge-base-hub'), {
    loading: () => <Loading />,
  }),
};
