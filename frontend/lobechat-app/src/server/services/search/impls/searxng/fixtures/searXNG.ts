...
export const hetongxue: SearXNGSearchResponse = {
  answers: [
    '老师好我叫何同学. 目标是做有意思的视频 合作请联系：<EMAIL>. 【何同学】我拍了一张600万人的合影...共计2条视频，包括：正片、教程等，UP主更多精彩视频，请关注UP账号。.',
  ],
  corrections: [],
  infoboxes: [],
  number_of_results: 0,
  ...
  results: [
    ...
    },
    {
      category: 'general',
      content:
        '日常. 老师好我叫何同学. 目标是做有意思的视频 合作请联系：<EMAIL>. bilibili入站必刷 (17/54) 镇站之宝大集合!. 经典永流传~. BGM：La Ciudad——ODESZA Rap God—— Eminem Stronger —— Kanye West 感谢龚哥从上海帮我办了两次电话卡，感谢我班团支书辅导我数电实验 ...',
      engine: 'qwant',
      engines: ['qwant', 'duckduckgo'],
    ...
    },
    {
      category: 'general',
      content:
        '听歌学习. 老师好我叫何同学. 目标是做有意思的视频 合作请联系：<EMAIL>. 视频中4分30秒便签纸上的想法来源于弱智吧。感谢所有参加我们这个测试的朋友，更感谢大家的一键三连!, 视频播放量 7509667、弹幕量 21154、点赞数 961103、投硬币枚数 518679、收藏 ...',
      engine: 'qwant',
      engines: ['qwant', 'duckduckgo'],
      parsed_url: [
        'https',
    ...
    },
    {
      category: 'general',
      content:
        '你眼里的光. 老师好我叫何同学. 目标是做有意思的视频 合作请联系：<EMAIL>. 制片：九老师翻页书：Flashcat闪电猫翻页书动画：超级小树动画：Joyteeth 小步乱撞音效：Jimmy感谢巡天者叶梓颐 狂奔的茄子指导我星空摄影 感谢SmallRig帮我打不锈钢云台 感谢俺的 ...',
      engine: 'duckduckgo',
      engines: ['duckduckgo'],
    ...
    },
    {
      category: 'general',
      content:
        "放假会做贼有意思的视频！工作事宜联系：<EMAIL> I'll make creative, funny, interesting videos while vacation. Business cooperation: <EMAIL>",
      engine: 'brave',
      engines: ['brave'],
